...
int cmd_get_system_consumptoin(char *s)
{
	...
	{   /*
		...
		*/
		if(FrmMain->bTEST_END_SWITCH_5V) return LOAD_TEST_PASS;
		float max_Voltage,min_Voltage;
...
//開COM
	...
	//讀
		...
		{
			strncpy(buff,RXBuff,ByteRead);
			if(strstr(buff,"3315F") || strstr(buff,"3310F") || strstr(buff,"3311F") || strstr(buff,"3312F")|| strstr(buff,"3313F")|| strstr(buff,"3314F"))
			{
