...
//開COM
	...
	//讀
		...
		{
			strncpy(buff,RXBuff,ByteRead);
			if(strstr(buff,"3315F")||strstr(buff,"3310F")||strstr(buff,"3311F")|| strstr(buff,"3316G"))
			{  //75W                 //150W                //300W               //400W
				DeviceCOM = "";
				if(dwMAX_WATT == LOADER_3310F)
				{
					if(strstr(buff,"3310F") || strstr(buff,"3311F")|| strstr(buff,"3316G"))
					{
				...
				{
					if(strstr(buff,"3311F")|| strstr(buff,"3316G"))
					{
