...
void __fastcall TfrmMsg::edtSetWorkOrderNumberMouseDown(TObject *Sender, TMouseButton Button,
...
void __fastcall TfrmMsg::edtSetEmployeeIDMouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y)
{
