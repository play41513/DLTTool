...
__published:	// IDE-managed Components
	...
	void __fastcall edtSetWorkOrderNumberMouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y);
	void __fastcall edtSetEmployeeIDMouseDown(TObject *Sender, TMouseButton Button,
          TShiftState Shift, int X, int Y);
